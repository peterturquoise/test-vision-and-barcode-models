#!/usr/bin/env python3
"""
Comprehensive PaddleOCR Test for All Images (Using Existing Container)
...
def main():
    ...
    try:
        ...
        if not test_container_health():
            print("❌ Container health check failed. Make sure the container is running on port 8000")
            return False
